...
const Header = () => {
  ...
  return ( 
    <div className="w-full h-20 bg-white border border-b-1 border-b-gray-800 font-titleFont sticky top-0 z-50">
        <div className='max-w-screen-xl h-full mx-auto flex items-center justify-between'>
        <Link to="/">
            <div>
                <img className='w-30' src={ logoDark } alt='logoDark' />
            </div>
        </Link>
        <div className='flex items-center gap-8 '>
            <ul className='flex items-center gap-8 '>
                <li className="text-base text-black font-bold hover:text-orange-900
                hover: underline underline-offset-2 decoration-1 cursor-pointer
                duration-300">
                    Home
                </li>
